...
public class NotificationProducer {
    ...
    Emitter<String> customerServiceEmitter;
    ...
    public CompletionStage<Void> sendOrderConfirmedNotification(Long orderId, Long customerId) {
        try {
            ...
            return notificationEmitter.send(jsonEvent);
        } catch (Exception e) {
            LOG.errorf("Failed to serialize notification event: %s", e.getMessage());
    ...
    public CompletionStage<Void> sendOrderEvent(String eventType, Long orderId, Long userId, String orderStatus, String previousStatus) {
        try {
            ...
            return orderEmitter.send(jsonEvent);
        } catch (Exception e) {
    ...
    public CompletionStage<Void> sendCustomerServiceEvent(String eventType, Long chatId, Long senderId, Long receiverId, 
        ...
        try {
            ...
            return customerServiceEmitter.send(jsonEvent);
        } catch (Exception e) {
            LOG.errorf("Failed to serialize customer service event: %s", e.getMessage());
            throw new RuntimeException("Failed to send customer service event", e);
        }
    }
